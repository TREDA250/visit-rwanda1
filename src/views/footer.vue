    ...
    <footer class="bg-green-800 text-white px-8 py-10 mt-10  ">
        <div class="flex flex-wrap justify-between gap-8">
         ...
         <div>
            ...
            <ul class="text-sm space-y-2">
                <li><RouterLink to="/" class="text-green-200 hover:text-yellow-300">Kigali</RouterLink></li>
                <li><RouterLink to="/" class="text-green-200 hover:text-yellow-300">Nothern Province</RouterLink></li>
                <li><RouterLink to="/" class="text-green-200 hover:text-yellow-300">Southern Province</RouterLink></li>
                <li><RouterLink to="/" class="text-green-200 hover:text-yellow-300">Eastern Province</RouterLink></li>
                <li><RouterLink to="/" class="text-green-200 hover:text-yellow-300">Western Province</RouterLink></li>
         ...
         <div>
            ...
            <ul class="text-sm space-y-2">
                <li class="text-green-300">123 Main Street, Kigali</li>
                <li class="text-green-300">Phone: +250 788 123 456</li>
                <li class="text-green-300">Email: info@temberurwanda.com</li>
            </ul>
        ...
        <!--place for copyright-->
         <div class="border-t border-green-600 mt-8 pt-4 text-sm">
            <p class="text-center">2026 Visit Rwanda</p>
         </div>
    </footer>
</template>